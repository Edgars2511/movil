...
if ($data !== null) {
    ...
    if ($result->num_rows > 0) {
        ...
        $updateUltimoAccesoSQL = "UPDATE usuarios SET ultimo_acceso = NOW() WHERE correo_electronico = '$correo_electronico'";
        $conexion->query($updateUltimoAccesoSQL);
        
        // Insertar el token y la fecha en la tabla de tokens
        $insertTokenSQL = "INSERT INTO token (correo_electronico, token, estatus, fecha_creacion) VALUES ('$correo_electronico', '$token', 'abierta', NOW())";
