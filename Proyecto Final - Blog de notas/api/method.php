...
$datos = json_decode($raw_data, true);
  ...
  switch($_SERVER['REQUEST_METHOD']) {
    case 'GET':
        ...
        elseif (isset($_GET['get5Notas'])) {
            $id_usuario = $_GET['id_usuario'];
            $sql = "SELECT * FROM notas WHERE id_usuario = $id_usuario ORDER BY id DESC LIMIT 5";
        }
    ...
    case 'POST':
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $sql = "INSERT INTO notas (titulo, cuerpo, id_usuario) VALUES ('$titulo', '$cuerpo', $user_id)"; // Reemplaza con el nombre de tu tabla
